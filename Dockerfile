...
CMD ["sh", "-c", "python task_manager/manage.py migrate --fake-initial && gunicorn --chdir /app/task_manager/task_manager --bind 0.0.0.0:8000 task_manager.wsgi:application"]